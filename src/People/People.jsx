...
{console.log(pagenum)}
    ...
    <div className=' position-relative  overflow-hidden pp'>
      ...
      <Link  to={`/Peopldetails/${person.id}`}> <img src={`https://image.tmdb.org/t/p/w500${person.profile_path}`} className='  w-100' alt="" /></Link>
     ...
     <Link className=' text-decoration-none' to={`/Peopldetails/${person.id}`}> 
...
peopleall("person",setpeople,pagenum)
